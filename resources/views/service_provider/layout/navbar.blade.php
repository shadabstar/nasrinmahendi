            ...
            <div class="topbar-left">
                <div class="text-center">
                    <a href="index.html" class="logo">
                        <a href="index.html" class="logo"><i class="icon-magnet icon-c-logo"></i><span>MY <i class="md md-album"></i>rder</span></a>
                    </a>
                </div>
            </div>
                            ...
                            <li class="dropdown">
                                <a href="" class="dropdown-toggle profile" data-toggle="dropdown"
                                    aria-expanded="true"><img
                                        src="{{ asset('service_provider/assets/images/users/user.jpg') }}"
                                        alt="user-img" class="img-circle"> </a>
                                <ul class="dropdown-menu">
                                    {{-- <li><a href="{{ route('admin-profile') }}"><i class="ti-user m-r-5"></i>
                                            Profile</a></li> --}}
                                    <li><a href="{{ route('service-provider-password') }}"><i class="ti-lock m-r-5 m-r-5"></i>
                                            Change Password</a></li>
                                    {{-- <li><a href="javascript:void(0)"><i class="ti-lock m-r-5"></i> Lock screen</a></li> --}}
                                    <li><a href="{{ route('logout') }}"><i class="ti-power-off m-r-5"></i>
                                            Logout</a></li>
                                </ul>
                            </li>
                        </ul>
